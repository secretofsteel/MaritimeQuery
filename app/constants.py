...
EXTRACT_SYSTEM_PROMPT = (
    ...
    "- The document title should be inferred from the main heading or prominent title text or filename if no title is found, or combination of both if needed for clarity"
    "doc_type options:"
